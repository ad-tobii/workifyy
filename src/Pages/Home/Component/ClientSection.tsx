      ...
      <section className="mx-auto">
        <div className="relative mt-[8rem] w-full rounded-[.6rem] bg-[url('/assets/ClientSection2.jpg')] bg-cover bg-center bg-no-repeat py-[5rem] pl-5 laptop:mx-auto laptop:w-[95%]">
          ...
          <div className="relative">
            <h2 className="max-w-[45rem]  text-[2.8rem] leading-[5rem] text-white miniTablet:text-[1.7rem]">
            ...
            <section className="flex gap-[2rem] pt-12 desktop:gap-[.8rem] pr-[.5rem] miniTablet:flex-col">
              <div className="w-[24rem] h-[8rem] rounded-md bg-[#32CD32] laptop:w-[22rem] laptop:h-[9rem]">
