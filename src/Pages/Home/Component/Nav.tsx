...
export default function Nav({ children }: NavProps) {
  ...
  return (
    <div className=" relative   w-full bg-[url('/assets/ClientSection2.jpg')] bg-cover bg-center  bg-no-repeat ">
      ...
      <header className="absolute inset-x-0 top-0 z-30 border-b p-3 xsMobile:fixed xsMobile:backdrop-blur miniMobile:fixed miniMobile:backdrop-blur mobile:fixed mobile:backdrop-blur miniTablet:fixed miniTablet:backdrop-blur tablet:fixed tablet:backdrop-blur miniLaptop:fixed miniLaptop:backdrop-blur laptop:fixed laptop:backdrop-blur">
        <nav
