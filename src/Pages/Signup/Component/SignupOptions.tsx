...
function SignupOtions() {
  ...
  return (
    <>
      ...
      after:border-solid after:border-gray-400 hover:border-[#32cd32] mobile:h-32 mobile:w-[19rem]  mobile:after:ml-5  miniTablet:h-[12rem] miniTablet:w-[20rem] miniTablet:rounded miniTablet:after:-ml-[8rem] miniTablet:after:h-10 miniTablet:after:w-10"
            htmlFor="radio1"
          >
