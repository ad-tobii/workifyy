  ...
  return (
    <>
      <div className=" tabs:mt-[7%]  mt-12  flex justify-center gap-x-5 ">
        ...
        />
        <label
          className=" pads:after:-mt-[11.5rem] pads:w-[20rem] tabs:w-[90%] tabs:h-[8rem] tabs:after:-mt-[16%] tabs:after:ml-[90%] h-56 w-[20%] cursor-pointer rounded
      border-2  border-solid border-gray-400 pt-4 text-white  after:-mt-[65%]
      ...
      after:w-7 after:rounded-full after:border-4   after:border-solid after:border-gray-400 hover:border-[#32cd32] mobile:h-[10rem] mobile:w-[80%] mobile:after:-mt-[40%] mobile:after:ml-[87%]"
          htmlFor="radio1"
        >
          <pre className=" pads:text-[175%] tabs:hidden ml-[5%] mt-6 text-[140%] mobile:hidden miniTablet:hidden">
        ...
        />
        <label
          className=" pads:after:-mt-[11.5rem] pads:w-[20rem] tabs:w-[90%] tabs:h-[8rem] tabs:after:-mt-[16%] tabs:after:ml-[90%] tabs:mt-[28%] tabs:-ml-[93.2%] h-56 w-[20%] cursor-pointer rounded
      border-2 border-solid border-gray-400 pt-4 text-white after:-mt-[65%]
      after:ml-[83%]  after:flex after:h-7
      after:w-7 after:rounded-full after:border-4 after:border-solid after:border-gray-400 hover:border-[#32cd32] mobile:-ml-[85%] mobile:mt-[50%] mobile:h-[10rem] mobile:w-[80%] mobile:after:-mt-[40%] mobile:after:ml-[87%]"
          htmlFor="radio2"
        >
          <pre className="tabs:hidden pads:text-[175%]  ml-[5%] mt-6 text-[140%] mobile:hidden miniTablet:hidden">
